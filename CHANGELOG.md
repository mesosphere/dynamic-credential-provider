...
* build(deps): Bump the all-go-mod-patch-and-minor group across 1 directory with 11 updates by @dependabot[bot] in https://github.com/mesosphere/dynamic-credential-provider/pull/453
* build(deps): Bump the all-go-mod-patch-and-minor group with 6 updates by @dependabot[bot] in https://github.com/mesosphere/dynamic-credential-provider/pull/454
* build(deps): Bump the all-go-mod-patch-and-minor group across 1 directory with 10 updates by @dependabot[bot] in https://github.com/mesosphere/dynamic-credential-provider/pull/470
* build(deps): Bump sigs.k8s.io/cloud-provider-azure from 1.34.3 to 1.35.3 in /credential-providers by @dependabot[bot] in https://github.com/mesosphere/dynamic-credential-provider/pull/468
* build(deps): Bump jetify-com/devbox-install-action from 0.14.0 to 0.15.0 by @dependabot[bot] in https://github.com/mesosphere/dynamic-credential-provider/pull/465
* build(deps): Bump sorenlouv/backport-github-action from 10.2.0 to 11.0.0 by @dependabot[bot] in https://github.com/mesosphere/dynamic-credential-provider/pull/464
* build(deps): Bump docker/login-action from 3 to 4 by @dependabot[bot] in https://github.com/mesosphere/dynamic-credential-provider/pull/458
* build(deps): Bump google.golang.org/grpc from 1.72.2 to 1.79.3 by @dependabot[bot] in https://github.com/mesosphere/dynamic-credential-provider/pull/463
* build(deps): Bump k8s.io/cloud-provider-aws from 1.34.1 to 1.35.1 in /credential-providers by @dependabot[bot] in https://github.com/mesosphere/dynamic-credential-provider/pull/462
* build(deps): Bump guyarb/golang-test-annotations from 0.8.0 to 0.9.0 by @dependabot[bot] in https://github.com/mesosphere/dynamic-credential-provider/pull/467
* build(deps): Bump actions/cache from 4 to 5 by @dependabot[bot] in https://github.com/mesosphere/dynamic-credential-provider/pull/449
