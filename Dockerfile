...
COPY kubelet-image-credential-provider-shim /usr/local/bin/kubelet-image-credential-provider-shim

ENTRYPOINT ["/usr/local/bin/kubelet-image-credential-provider-shim"]
